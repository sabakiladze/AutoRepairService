...

    {
        public void Configure(EntityTypeBuilder <MechanicBankAccount> builder)
        {
            ...
            builder.HasOne(x => x.MechanicProfile)
                ...
                .HasPrincipalKey(x => x.UserId).OnDelete(DeleteBehavior.Cascade);  // ეს ნიშავს რომ fk კავშირი არ მყარდება მხოლოდ მექანიკოსი კლასის pk-ით, მას აქვს userid რომლითაც შეიძლება რომდაკავშირდეს.
